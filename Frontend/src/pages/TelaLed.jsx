      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="bg-[#1c1f24] p-8 rounded-2xl shadow-lg border border-[#2a2d32]">
          <h2 className="text-2xl font-semibold mb-4 text-white">
            ...
            <span
              className={`ml-2 ${
                statusLed === "1" ? "text-green-400" : "text-red-500"
              }`}
            >
              {statusLed === "1"
                ? "Ligado"
        ...
        <a href="https://wokwi.com/projects/438624783625570305" target='_blank' className="bg-blue-600 hover:bg-blue-700 transition-all duration-300 text-white font-semibold py-2 px-6 rounded-full shadow-md">Projeto Led</a>
      </div>
      </div>
    </div>
  );
